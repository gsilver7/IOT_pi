...
export class WeatherService {
  ...
  async getVilageFcst(baseDate: string, baseTime: string, nxin: string, nyin: string) {
    const endpoint = 'https://apihub.kma.go.kr/api/typ02/openApi/VilageFcstInfoService_2.0/getUltraSrtFcst';
...
async getNowcast( nxin: string, nyin: string) {
  const endpoint = 'https://apihub.kma.go.kr/api/typ02/openApi/VilageFcstInfoService_2.0/getUltraSrtNcst';
